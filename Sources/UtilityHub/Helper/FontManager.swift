...
// 
//
// Created by Rakibur Khan on 17/9/23.
...
final public class FontManager {
    ...
    public class func registerAllFonts(bundle: Bundle = Bundle.main) {
        registerAllFonts(bundle: bundle, completion: nil)
    }
     ...
     */
    public class func registerAllFonts(bundle: Bundle = Bundle.main, completion handler: (([String])->Void)?) {
...
private extension FontManager {
    ...
    final class func fonts(fromPath path: String, withContents contents: [String]) -> [Font] {
        ...
        for fileName in contents {
            ...
            if fileName.contains(SupportedFontExtensions.TrueTypeFont.rawValue) || fileName.contains(FontManager.SupportedFontExtensions.OpenTypeFont.rawValue) {
